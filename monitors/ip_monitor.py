...
define_config_option(
    __monitor__,
    "module",
    "Always ``scalyr_agent.builtin_monitors.ip_monitor``",
...
define_config_option(
    __monitor__,
    "server",
    "The address to return the ip address",
...
define_log_field(__monitor__, "monitor", "Always ``ip_monitor``.")
define_log_field(
    __monitor__,
    "instance",
...
class UrlMonitor(ScalyrMonitor):
    ...
    def _initialize(self):
        ...
        self._base_headers = {
            "User-Agent": "scalyr-agent-%s;monitor=ip_monitor" % (SCALYR_VERSION)
        }
    ...
    def build_request(self):
        ...
        request = six.moves.urllib.request.Request(self.server, data=self.request_data)
